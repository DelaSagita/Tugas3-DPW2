          ...
          <div class="container ">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-7">
                <div class="img-box">
                  <img src="{{url('public')}}/images/slider-img.jpg" alt="">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="carousel-item">
          <div class="container ">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-7">
                <div class="img-box">
                  <img src="{{url('public')}}/images/slider1-img..jpg" alt="">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="carousel-item">
          <div class="container ">
            <div class="row">
              ...
              <div class="col-md-6 col-lg-7">
                <div class="img-box">
                  <img src="{{url('public')}}/images/slider2-img.jpg" alt="">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/images/p1.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/images/p2.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/images/p3.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/images/p4.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="box">
            <div class="img-box">
              <img src="{{url('public')}}/images/p6.jpg" alt="">
            </div>
            <div class="detail-box">
              <span class="rating">
                <i class="fa fa-star" aria-hidden="true"></i>
